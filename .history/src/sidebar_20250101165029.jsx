...
const Sidebar = ({ isSidebarOpen }) => {
  ...
  return (
    <div
      className={`${isSidebarOpen ? 'w-64' : 'w-20'} bg-gdark:bg-primary-dark h-screen fixed top-10 left-0 text-secondary dark:text-secondary-dark flex flex-col transition-all duration-300 ease-in-out z-20`}
    >
