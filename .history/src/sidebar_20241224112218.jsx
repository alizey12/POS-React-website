    ...
    <div>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          {/* <span className="self-center text-2xl font-semibold whitespace-nowrap text-black dark:text-white">Dashboard</span> */}
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              <ul
                className={`py-2 space-y-2 transition-all ${isOpen ? 'block' : 'hidden'}`}
              >
                <li>
                  <a
                    href="#"
