...
const SignupLogin = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.Role) newErrors.Role = 'Please enter Role';
    if (formData.Role && formData.Role.toLowerCase() !== 'cashier') {
      newErrors.Role = 'Role must be "Cashier"';
    }
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-teal-900 to-yellow-500">
      <div className=" bg-white sm:w-auto md:w-1/3  shadow-lg rounded-lg">
