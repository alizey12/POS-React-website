      ...
      <div className="flex bg-white shadow-lg rounded-lg overflow-hidden w-3/4 max-w-4xl">
        ...
        <div className="w-1/2 bg-fuchsia-900 p-8">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-yellow-700 text-white p-2 rounded-md hover:bg-amber-300-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              {isLogin ? 'Login' : 'Sign Up'}
            </button>
          </form>
