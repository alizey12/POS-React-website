...
import {src} from "../src/assets/3D perfume render.jpeg";
import moduleName from '../src/assets/23d171a0-662f-4c3e-a79c-5777ccdc687c.jpeg';

const Card = ({ title, description, discount, src }) => (
  <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative">
    ...
    <img className="rounded-t-lg" src={src} alt="Technology Icon" />
    <div className="p-5">
