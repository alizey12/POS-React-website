...
const SignupLogin = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen  bg-teal-800 to-yellow-500">
      <div className=" bg-white w-1/3 shadow-lg rounded-lg">
       
        <div className="w-full bg-white roun shadow-gray-900 shadow-2xl p-8 justify-center">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-teal-400 text-white p-2 rounded-md hover:bg-teal-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              {isLogin ? 'Login' : 'Sign Up'}
            </button>
          </form>
