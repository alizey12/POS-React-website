...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen max-w-screen bg-fuchsia-950 shadow-xl shadow-neutral-900 flex flex-row items-center justify-center">
      <img className='max-w-screen justify-end flex bg-cover' width={1000} src="https://img.freepik.com/premium-vector/mountains-landscape-design_24911-25891.jpg" alt="" />
