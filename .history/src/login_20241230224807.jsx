...
const SignupLogin = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r bg-purple-800 to-yellow-500">
      <div className="flex bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl">
       
        <div className="w-full bg-fuchsia-900 p-8 flex flex-col justify-center">
