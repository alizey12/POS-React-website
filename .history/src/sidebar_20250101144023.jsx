import { FaChevronDown ,FaHome, MdOutlineSecurity} from "react-icons/fa";
    ...
    >
      ...
      <ul className="mt-6">
       <li className="p-4 hover:bg-blue-600 cursor-pointer flex gap-3"><FaHome /> Dashboards</li>
        <li
          className="p-4 hover:bg-blue-600 cursor-pointer flex gap justify-between items-center"
        ...
        <li className="p-4 hover:bg-blue-600 cursor-pointer">Users</li>
        <li
