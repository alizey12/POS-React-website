...
const SignupLogin = () => {
  ...
  return (
    ...
    <div className="flex justify-center h-screen bg-fuchsia-800 content-center">
      <div className="w-full max-w-md p-8 space-y-4 justify-center content-center rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold text-center">
          {isLogin ? 'Login' : 'Sign Up'}
        </h2>
        <form onSubmit={handleSubmit} className="space-y-4 bg-red-500 justify-center content-center">
          <div>
