...
import { useState } from 'react';
 ...
 function LoginPage() {
  ...
  return (
    <div className="min-h-screen max-w-screen bg-fuchsia-950 flex flex-row items-center justify-center">
   
  
      <div className=" p-10 rounded-lg bg-fuchsia-800 shadow-xl shadow-neutral-900 w-full max-w-md">
      <img src="https://img.freepik.com/premium-vector/mountains-landscape-design_24911-25891.jpg" className='w-96' alt="" />
