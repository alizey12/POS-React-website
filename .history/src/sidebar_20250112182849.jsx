...
const Sidebar = ({ isSidebarOpen }) => {
  ...
  return (
    <divdark
      className={`${isSidebarOpen ? 'w-64' : 'w-20'} bg-dark bg-[var(--sidebar-bg)]  h-screen fixed top-140 left-0 text-secondary dark:text-secondary-dark flex flex-col transition-all duration-300 ease-in-out z-20`}
    >
