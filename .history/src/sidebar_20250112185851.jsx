...
const Sidebar = ({ isSidebarOpen }) => {
  ...
  return (
    ...
    >
      ...
      <ul className="mt-6">
        <li className="p-4 hover:text-teal-600 cursor-pointer flex items-center gap-3">
          <FaHome className="text-xl" />
          {isSidebarOpen && <span>Dashboards</span>}
        </li>
        <li
          className="p-4 hover:text-teal-600 cursor-pointer flex items-center justify-between gap-3"
        ...
        {submenuOpen['instruction'] && isSidebarOpen && (
          <ul className="pl-8">
            <li className="p-2 hover:text-teal-600">Getting Started</li>
            <li className="p-2 hover:text-teal-600">Tutorials</li>
          </ul>
        )}
        <li className="p-4 hover:text-teal-600 cursor-pointer flex items-center gap-3">
        ...
        >
          <div className="flex items-center hover:text-teal-600 gap-3">
        ...
        {submenuOpen['contact'] && isSidebarOpen && (
          <ul className="pl-8">
            <li className="p-2 hover:text-teal-600">Email</li>
            <li className="p-2 hover:text-teal-600">Phone</li>
          </ul>
        )}
      </ul>
    </divdark>
