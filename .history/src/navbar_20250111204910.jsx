...
const Navbar = ({ toggleSidebar, isSidebarOpen, toggleTheme }) => {
  return (
    <nav className="fixed h-12 top-0 left-0 w-full text-secondary dark:text-secondary-dark bg-dark bg-[var(--sidebar-bg)] shadow-md flex items-center justify-between px-4 py-2 z-10 transition-all">
      <button
