          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              ...
              <input
                type="email"
                name="email"
                value={formData.email} onClick={<h6>please enter confirm Password</h6>}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange} onClick={<h6>please enter  Password</h6>}
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  type="password"
                  name="confirmPassword" onClick={<h6>please enter confirm Password</h6>}
